...
import com.tiny.demo.firstlinecode.kfysts.chapter12.ryg.ImageLoader;
 ...
 *
 * @author tiny
 * @date 2018/5/27 上午1:09
 */
public class AndroidKfystsChapter121Activity extends AppCompatActivity implements AbsListView.OnScrollListener {
    public static final String TAG = AndroidKfystsChapter121Activity.class.getSimpleName();
    ...
    public static void actionStart(Context context) {
        Intent starter = new Intent(context, AndroidKfystsChapter121Activity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_android_kfysts_chapter121);
        ButterKnife.bind(this);
        initData();
        initView();
        mImageLoader = ImageLoader.build(AndroidKfystsChapter121Activity.this);
    }
